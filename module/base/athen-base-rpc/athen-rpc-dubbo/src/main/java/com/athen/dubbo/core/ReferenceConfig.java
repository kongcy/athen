...
public class ReferenceConfig<T> extends AbstractReferenceConfig {
    ...
    public ReferenceConfig(FReference reference) {
        appendAnnotation(FReference.class, reference);
    }
    ...
    private void init() {
        ...
        } else if( this.filter!=null && this.filter.indexOf("json")>=0){
        	//interfaceClass = JsonService.class;
        }else {
            try {
